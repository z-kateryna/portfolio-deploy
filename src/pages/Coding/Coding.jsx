      ...
      <div className="coding__wrapper">
        <div className="coding__hero-content-container">
          ...
          <div className="coding__hero-copy">
            ...
            <p className="coding__hero-header">
              I do like to get busy coding. </p>
              <img className="coding__gif" src={CatGif} />
                         </div>
              <p className="coding__hero-header">Check out some of my freelance and bootcamp projects. My skillset includes:</p>
        
          </div>
          <div className="coding__tags-container">
            {['HTML','CSS','Javascript','Sass','Tailwind','React','Node.js','Express','Mysql','Bootstrap','Github','Postman','Webflow','Framer','Wix','Figma','Miro','Jira','Photoshop','Illustrator','InDesign'].map(skill => (
              <div key={skill} className="coding__tag">{skill}</div>
            ))}
          </div>
        </div>
        <section className="coding__content">
          <div className="coding__content-wrapper">
            {[{
              img: MockUpAgustin,
              tags: ['Front-End', 'Website', 'React', 'Vite', 'UI/UX Design', 'Sass', 'i18n', 'EmailJS', 'Netlify', 'GitHub'],
              ...
              img: MockUpCapstone,
              tags: ['Full-stack', 'Web app', 'OpenAI API', 'React', 'Node', 'Express', 'UI Design', 'GitHub', 'Prompt engineering'],
              header: 'b.smart app',
              ...
              img: MockUpCandubai,
              tags: ['Webflow development', 'Website', 'UI/UX Design', 'Graphic Design'],
              ...
              img: MockupInstock,
              tags: ['Full-stack', 'Web app', 'MySQL', 'React', 'Node', 'Express', 'Jira', 'GitHub'],
              ...
              tags: ['Framer development', 'Website', 'UI/UX Design', 'Graphic Design'],
              ...
              img: MockUpBandsite,
              tags: ['Full-stack', 'Website', 'Dynamic data', 'DOM', 'React', 'Github'],
              ...
              img: MockUpRilel,
              tags: ['Wordpress Development', 'Website', 'Elementor', 'UI/UX Design', 'Graphic Design'],
              ...
              img: MockUpMicrosoft,
              tags: ['24-Hour Hackathon', 'AI', 'OpenAI API', 'Full Stack', 'Website'],
              ...
              <div className="coding__content-card" key={project.header}>
                <img className="coding__content-img" src={project.img} alt={`mock up of ${project.header}`} />
                <div className="coding__content-tags-container">
                  {project.tags.map(tag => <div key={tag} className="coding__content-tag">{tag}</div>)}
                </div>
                <h2 className="coding__content-header">{project.header}</h2>
                <p className="coding__content-copy">{project.copy}</p>
                <a href={project.link} target="_blank" rel="noopener noreferrer" className="coding__content-button">
                  {project.linkText}
                </a>
              </div>
            ))}
