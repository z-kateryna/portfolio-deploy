        ...
        <a className="case-studies__pyrukynd" href="#">
          ...
          <div className="case-studies__copy-container">
            <h2 className="case-studies__header">
              Designing for Impact: Launching Pyrukynd's Digital Presence
            </h2>
            <p className="case-studies__copy">
              This case study explores the design and development process behind
              the Pyrukynd website, focusing on creating an engaging,
              user-friendly digital resource for patients and healthcare
              providers, aimed at delivering crucial treatment information with
              clarity and ease.
            </p>
